...
export function StatsGrid() {
  ...
  return (
    <section className="grid grid-cols-3 lg:gap-6 gap-1 lg:mb-8 mb-2 sticky lg:top-[55px] top-[75px] bg-finance-surface dark:bg-gray-900 z-10" aria-live="polite" aria-label="Financial summary">
      <StatCard 
        label="Total Balance" 
