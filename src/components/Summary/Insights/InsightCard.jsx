...
const InsightCard = ({ title, value, highlight, icon: Icon, type = 'info', tooltip }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-48 p-2 text-xs font-medium bg-gray-900 dark:bg-gray-600 text-white rounded-lg shadow-xl">
          {tooltip}
          <div className="absolute top-full left-1/2 -translate-x-1/2 border-8 border-transparent border-t-gray-900 dark:border-t-gray-600" />
        </div>
      </div>
      ...
      <div className="flex items-start justify-between lg:gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 mb-1">
            <p className="text-[10px] font-bold uppercase tracking-wider opacity-70 dark:opacity-100">
              {title}
            </p>
          </div>
          <h3 className="text-base font-bold text-gray-900 dark:text-gray-300 leading-tight">
            {value}
          </h3>
