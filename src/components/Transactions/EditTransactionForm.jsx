...
export function EditTransactionForm({ initialData, onSubmit, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="edit-transaction-type" className="text-sm font-medium text-gray-700 dark:text-gray-300">Type</label>
        <select 
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="edit-transaction-category" className="text-sm font-medium text-gray-700 dark:text-gray-300">Category</label>
        <select 
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="edit-transaction-amount" className="text-sm font-medium text-gray-700 dark:text-gray-300">Amount (₹)</label>
        <input 
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="edit-transaction-note" className="text-sm font-medium text-gray-700 dark:text-gray-300">Note (optional, max 50 chars)</label>
        <input 
